...
using OgrenciKaydi.Data;
using OgrenciKaydi.Models;

namespace OgrenciKaydi.Controllers
{
    public class OgrencilersController : Controller
    {
        private OgrenciKaydiDBContext db = new OgrenciKaydiDBContext();
        ...
        public ActionResult Create([Bind(Include = "ID,OkulNo,Adi,Soyadi,Bolum")] Ogrenciler ogrenciler)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,OkulNo,Adi,Soyadi,Bolum")] Ogrenciler ogrenciler)
        {
            if (ModelState.IsValid)
            {
